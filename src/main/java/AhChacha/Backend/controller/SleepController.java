...
public class SleepController {
    ...
    public ResponseEntity<SleepIdResponse> createSleep(@RequestBody SleepRequest sleepRequest, @PathVariable(value = "memberId") Long id) {
    ...
    // 수면 기록 리스트 전체 조회
    @GetMapping("/{memberId}?")
    public ResponseEntity<SleepsResponse> findSleep(@PathVariable("memberId") Long id){
